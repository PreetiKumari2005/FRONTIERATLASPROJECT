...
interface SplitGridProps {
  textToVideoData: LeaderboardRow[];
  imageToVideoData: LeaderboardRow[];
  loading: boolean;
  onViewCategoryClick: (category: string) => void;
}

export const VideoSplitGrid: React.FC<SplitGridProps> = ({
  textToVideoData,
  imageToVideoData,
  loading,
  onViewCategoryClick
        ...
        <div>
          ...
          <div className="p-4 space-y-3">
            {dataSlice.map((model, idx) => {
              ...
              const confIntervalString = model.confidenceInterval || '±10';
              const rawCIValue = parseFloat(confIntervalString.replace(/[^\d.]/g, '')) || 10;
