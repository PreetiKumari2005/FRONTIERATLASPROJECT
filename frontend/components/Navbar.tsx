      ...
      <nav className="font-sans sticky top-0 h-[56px] xl:h-[52px] w-full bg-[#F8F7F2]/80 backdrop-blur-md border-b border-[#E5E5E0] flex items-center justify-between px-4 md:px-8 xl:px-12 gap-3 xl:gap-4 shrink-0 z-50 transition-all duration-300">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <button
            ...
            className="xl:hidden p-2 -ml-2 text-[#111111] hover:bg-[#F5F5F0] rounded-md transition-colors"
        ...
        <div className="hidden lg:flex flex-1 items-center justify-center max-w-[240px] xl:max-w-[400px] mx-4">
          <AnimatePresence>
            {shouldShowSearch && (
              <motion.div
        ...
        <div className="flex items-center gap-6 xl:gap-8 shrink-0">
          {/* Desktop Nav Links */}
          <div className="hidden lg:flex items-center gap-5 xl:gap-6 pt-1">
            <Link
              href="/tasks"
              data-text="Tasks"
          ...
          <div className="hidden xl:flex items-center gap-4 border-l border-[#E5E5E0] pl-6 shrink-0">
