...
export default function TopBar() {
  return (
    <header
      className="fixed top-0 left-0 right-0 z-30 bg-white flex items-center px-4 gap-4 border-b-[0.5px] border-gray-300"
      style={{ height: TOPBAR_H }}
    >
      <div className="flex items-center gap-2 flex-shrink-0 w-[220px] pl-1">
